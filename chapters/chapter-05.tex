...
\begin{itemize}
    \item The \ac{prm} reevaluates relevant portions of the expression based on data dependencies, offering fine-grained reactivity.
    \item The \ac{rmsm}: Introduces reactivity only to messages and sensor readings, maintaining the original Collektive \ac{dsl}.
\end{itemize}
...
In this section, the implementation of some key components of the \ac{prm} is proposed.
