...
\end{itemize}
\sidenote{What about aggregate, align and share?}
...
\begin{figure}
    ...
    \caption{A graphical representation of the gradient implementation in ScaFi after stabilization.}
...
\begin{figure}
    ...
    \end{subfigure}
    \caption{Dependencies between sub-computations in gradient program (\Cref{lst:frasp-gradient.scala})}
\end{figure}
